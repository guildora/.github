...
A modern, self-hostable community platform with an extensible app ecosystem — landing pages, a community hub, and a Discord bot, all in one.
...
Guildora is a full-stack platform for Discord communities that goes beyond a simple bot. It provides a **public landing page**, an **internal community hub** with role-based access, and a **Discord bot** — all connected and working together.

Community developers can build custom apps (pages, API routes, bot hooks, configurations) that integrate directly into the hub.
...
**[Documentation](https://github.com/guildora/docs)** · **[App Template](https://github.com/guildora/guildora-app-template)**
